...
export const strings: Strings = {
  ...
  "settings.network.wifi_pair_desc":
    "Envie fotos e arquivos por Wi-Fi em vez de Bluetooth. Funciona entre dois iPhones, ambos com iOS 26 ou posterior, enquanto o Airhop estiver aberto. Pareie uma vez e depois acontece sozinho.",
  "settings.network.wifi_paired": "Dispositivos pareados",
  "settings.network.wifi_pair_find": "Encontrar um dispositivo",
  "settings.network.wifi_pair_find_desc":
    "Procurar um iPhone por perto que esteja se mostrando",
  ...
  "settings.network.wifi_pair_forget":
    "Para remover um pareamento, abra o app Settings e veja em Privacy & Security. O Airhop não pode desfazer isso por você.",
