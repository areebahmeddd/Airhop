...
export const strings: Strings = {
  ...
  "settings.network.wifi_pair": "快速傳輸",
  "settings.network.wifi_pair_desc":
    "透過Wi-Fi而非Bluetooth傳送照片和檔案。可在兩台iPhone之間使用，兩台都需為iOS 26或更新版本，且Airhop處於開啟狀態。配對一次，之後便會自動進行。",
  "settings.network.wifi_paired": "已配對的裝置",
  "settings.network.wifi_pair_find": "尋找裝置",
  "settings.network.wifi_pair_find_desc": "尋找附近正在顯示自己的iPhone",
  ...
  "settings.network.wifi_pair_forget":
    "若要移除配對，請開啟Settings App並在Privacy & Security下查看。Airhop無法代你復原。",
