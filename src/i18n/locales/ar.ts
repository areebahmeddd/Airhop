// ar: translated from src/i18n/locales/en.ts.
//
...
export const strings: Strings = {
  ...
  "chat.attach.bitchat_too_big_body":
    "{name} يستخدم bitchat، وهو يتوقف في منتصف الملف الكبير. ما دون 350 كيبيبايت تقريبًا موثوق. أما الإرسال إلى جهة اتصال على Airhop فلا حد له.",
  ...
  "transfer.too_large":
    "{kind} حجمه {size} كيبيبايت، أي فوق حد {cap} كيبيبايت.",
