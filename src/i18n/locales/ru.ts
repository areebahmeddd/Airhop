// ru: translated from src/i18n/locales/en.ts.
//
...
// the words, and is meant to be read beside it.
...
export const strings: Strings = {
  ...
  "chat.attach.bitchat_too_big_body":
    "{name} пользуется bitchat, а он бросает большой файл на полпути. Примерно до 350 КиБ надёжно. При отправке контакту в Airhop такого ограничения нет.",
  ...
  "transfer.too_large": "{kind}: {size} КиБ, это больше предела в {cap} КиБ.",
