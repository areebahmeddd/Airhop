        ...
        <EnglishContent className="mt-14 lg:grid lg:grid-cols-[176px_1fr] lg:gap-14">
          ...
          <div className="min-w-0 space-y-14">
            ...
            >
              ...
              <Figure caption="Fragmentation of a file at the 1 MB cap. The cap exists to stay compatible with bitchat's decoder and to keep a transfer down to something a person will actually wait for.">
                <Fragmentation />
              </Figure>
              ...
              <Table
                ...
                rows={[
                  ...
                  ["Envelope size", "16 KB", "Text only, media is never couriered"],
            ...
            >
              ...
              <Note label="Why attachments are signed but not encrypted">
                Encrypting them would break the file transfer format bitchat already decodes. The
                trade is deliberate: cross-app compatibility was judged worth more than
                confidentiality on media that is usually sent to a room anyway. Nobody can forge or
                alter an attachment, because the signature covers it, but{" "}
            ...
            >
              ...
              <Table
                ...
                rows={[
                  ...
                  ["FILE_TRANSFER", "0x22", "File, image, voice note, 1 MB cap"],
