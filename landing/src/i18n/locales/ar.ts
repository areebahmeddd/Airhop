...
const strings: Strings = {
  ...
  "home.about.body.built":
    "Airhop تطبيق مفتوح المصدر لنظامي iOS و Android للمراسلة الخاصة بين الأجهزة مباشرةً عبر {mesh}. بُني على أساس {bitchat}، مع إعادة استخدام {wire_protocol} ونموذج الأمان الخاص به، ثم توسيعهما بدعم Tor ومدفوعات {ecash} دون اتصال وذكاء اصطناعي دون اتصال. يعمل بلا أي اتصال بالإنترنت، وتُنقل الرسائل تلقائيًا عبر الأجهزة القريبة (نحو 10 إلى 30 مترًا لكل قفزة داخل المباني، وأبعد في الأماكن المفتوحة)، حتى 7 قفزات.",
