...
const strings: Strings = {
  ...
  "home.about.body.internet":
    "သင်နှင့် သင့်အဆက်အသွယ်သည် Bluetooth အကွာအဝေးပြင်ပတွင် ရှိနေချိန်တွင် {nostr} ရီလေများသည် အင်တာနက်မှတစ်ဆင့် တံတားအဖြစ် ဆောင်ရွက်ပေးပြီး {nip17} ပုံစံဖြင့် ထုပ်ပိုးထားသော တိုက်ရိုက်စာများကို သုံးသည်။ ထို့ကြောင့် နှစ်ဦးစလုံး အွန်လိုင်းရောက်နေချိန်တွင် mesh သည် ကမ္ဘာအနှံ့ ကျယ်ပြန့်သွားသည်။ {tor} အထောက်အပံ့ကို iOS နှင့် Android နှစ်ခုစလုံးတွင် {arti} မှတစ်ဆင့် ရနိုင်သည်။",
