...
const strings: Strings = {
  ...
  "home.about.body.built":
    "Airhop သည် {mesh} ပေါ်တွင် စက်ပစ္စည်းအချင်းချင်း တိုက်ရိုက် သီးသန့်စာပို့ရန်အတွက် iOS နှင့် Android အတွက် ပွင့်လင်းအရင်းအမြစ်အက်ပ်တစ်ခုဖြစ်သည်။ ၎င်းကို {bitchat} အခြေခံပေါ်တွင် တည်ဆောက်ထားပြီး ၎င်း၏ {wire_protocol} နှင့် လုံခြုံရေးပုံစံကို ပြန်လည်အသုံးပြုကာ Tor၊ အွန်လိုင်းမလိုသော {ecash} ငွေပေးချေမှုနှင့် အွန်လိုင်းမလိုသော AI တို့ဖြင့် တိုးချဲ့ထားသည်။ အင်တာနက်လုံးဝမရှိဘဲ အလုပ်လုပ်ပြီး စာများသည် အနီးအနားရှိစက်များမှတစ်ဆင့် အလိုအလျောက် ဆက်လက်ရောက်ရှိသည် (အိမ်တွင်း တစ်ဆင့်လျှင် ခန့်မှန်း ၁၀ မှ ၃၀ မီတာ၊ ကွင်းပြင်တွင် ပိုဝေး)၊ ခုနစ်ဆင့်အထိ။",
