...
const strings: Strings = {
  ...
  "home.about.body.internet":
    "நீங்களும் உங்கள் தொடர்பும் Bluetooth எல்லைக்கு வெளியே இருக்கும்போது, {nostr} மறுபரப்பிகள் இணையம் வழியாகப் பாலமாகச் செயல்படுகின்றன; {nip17} வடிவில் பொதிந்த நேரடிச் செய்திகள் பயன்படுத்தப்படுகின்றன, எனவே இருவரும் இணையத்தில் இருக்கும்போது மெஷ் உலகளவில் விரிகிறது. {tor} ஆதரவும் iOS ({arti} வழியாக) மற்றும் Android ({orbot} வழியாக) இரண்டிலும் உள்ளது.",
