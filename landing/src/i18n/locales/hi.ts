...
const strings: Strings = {
  ...
  "home.about.body.internet":
    "जब आप और आपका संपर्क Bluetooth की सीमा से बाहर हों, तो {nostr} रिले इंटरनेट पुल का काम करते हैं, और {nip17} शैली के गिफ़्ट-रैप्ड डायरेक्ट मैसेज इस्तेमाल होते हैं, जिससे जब भी आप दोनों ऑनलाइन हों, मेश दुनिया भर तक फैल जाता है। {tor} समर्थन iOS ({arti} के ज़रिये) और Android ({orbot} के ज़रिये) दोनों पर उपलब्ध है।",
