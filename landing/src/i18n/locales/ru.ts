...
const strings: Strings = {
  ...
  "home.about.body.internet":
    "Когда вы и ваш собеседник вне зоны действия Bluetooth, реле {nostr} служат мостом через интернет, используя личные сообщения в обёртке формата {nip17}, поэтому mesh расширяется до глобальной, пока вы оба в сети. Поддержка {tor} также доступна и на iOS (через {arti}), и на Android (через {orbot}).",
