...
const strings: Strings = {
  ...
  "home.about.body.built":
    "‏Airhop یک اپلیکیشن متن‌باز برای iOS و Android است برای پیام‌رسانی خصوصی نظیربه‌نظیر روی {mesh}. این اپلیکیشن بر پایهٔ {bitchat} ساخته شده، {wire_protocol} و مدل امنیتی آن را دوباره به کار می‌گیرد و سپس آن را با Tor، پرداخت‌های آفلاین {ecash} و هوش مصنوعی آفلاین گسترش می‌دهد. بدون هیچ اتصال اینترنتی کار می‌کند و پیام‌ها به‌طور خودکار میان دستگاه‌های نزدیک جابه‌جا می‌شوند (حدود ۱۰ تا ۳۰ متر در هر پرش در فضای بسته و بیشتر در فضای باز)، تا ۷ پرش.",
  ...
  "home.about.body.internet":
    "وقتی شما و مخاطبتان بیرون از برد Bluetooth هستید، رله‌های {nostr} نقش پل اینترنتی را بازی می‌کنند و از پیام‌های مستقیم بسته‌بندی‌شده به شکل {nip17} استفاده می‌کنند، پس تا وقتی هر دو آنلاین باشید مش تا سراسر جهان گسترش می‌یابد. پشتیبانی از {tor} هم روی iOS (از طریق {arti}) و هم روی Android (از طریق {orbot}) در دسترس است.",
