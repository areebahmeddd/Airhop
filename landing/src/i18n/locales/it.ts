...
const strings: Strings = {
  ...
  "home.hero.body":
    "I telefoni vicini formano una rete mesh Bluetooth e inoltrano i tuoi messaggi fino a sette salti, cifrati end-to-end. {no_servers}, {no_accounts}, {no_tracking}.",
  ...
  "home.about.body.built":
    "Airhop è un'app open source per iOS e Android per la messaggistica privata peer-to-peer su {mesh}. È costruita sulle fondamenta di {bitchat}, ne riutilizza il {wire_protocol} e il modello di sicurezza, e li estende con Tor, pagamenti {ecash} offline e IA offline. Funziona senza alcuna connessione a internet e i messaggi vengono inoltrati automaticamente tra i dispositivi vicini (circa 10-30 metri per salto al chiuso, di più all'aperto), fino a 7 salti.",
  ...
  "home.features.messaging.files.line": "Qualsiasi formato, fino a 1 MB, senza bisogno di segnale.",
