...
- fix: stop peer selector update loop and stabilize Expo runtime

RISKY FIX, check audio logic in chat (by @areebahmeddd) [4261b7d]
...
- Feat/mesh geo channels and ui overhaul (#2) (by @Areeb Ahmed) [cf8e7b3]
